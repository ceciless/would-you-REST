...
class EventsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $events = $em->getRepository('ApiBundle:Events')->findAll();
    ...
    {
        $event = new Events();
        $form = $this->createForm('Api\ApiBundle\Form\EventsType', $event);
    ...
    {
        $deleteForm = $this->createDeleteForm($event);
        $editForm = $this->createForm('Api\ApiBundle\Form\EventsType', $event);
    ...
    /**
     * Finds and displays all matches entities of the event.
     *
     */
    public function scheduleAction(Events $event)
    {
       $em = $this->getDoctrine()->getManager();
       $matchs = $em->getRepository('ApiBundle:Matches')->byEvent($event);
      // $event = $em->getRepository('ApiBundle:Events')->find($event);
